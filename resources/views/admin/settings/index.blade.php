                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div>
                                                            <img src="{{ asset('uploads/' . $settings->banner) }}"
                                                                alt="" class="w_200">
                                                        </div>
                                                    </div>
                                                    <div class="form-group mb-3">
                                        ...
                                        <div class="tab-pane fade" id="i2" role="tabpanel" aria-labelledby="i2-tab"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label>Phone</label>
                                                        <input type="text" name="top_phone" class="form-control"
                                                            value="{{ $settings->top_phone }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label>Email</label>
                                                        <input type="text" name="top_email" class="form-control"
                                                            value="{{ $settings->top_email }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Top Bar - End -->
                                        </div>
                                        <div class="tab-pane fade" id="i3" role="tabpanel"
                                            aria-labelledby="i3-tab" tabindex="0">
                                            <!-- CTA - Start -->
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select name="cta_status" class="form-select">
                                                            <option value="Show"
                                                                @if ($settings->cta_status == 'Show') selected @endif>Show
                                                            </option>
                                                            <option value="Hide"
                                                                @if ($settings->cta_status == 'Hide') selected @endif>Hide
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
